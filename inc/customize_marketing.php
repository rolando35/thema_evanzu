...
function customize_page_marketing($wp_customize)
{
    ...
    $wp_customize->add_setting('marketing[galeria-image-one]', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'esc_url',
        'type'               => 'option'

    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'galeria-image-one', array(
        'label'                => __('Imagen de slider', ''),
        'section'              => 'marketing_galeria',
        'settings'             => 'marketing[galeria-image-one]',
        'description'       => __('Sube una imagen para el slider de la página marequeting digital', '')
    )));

    // //////////////

    $wp_customize->add_setting('marketing[galeria-image-two]', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'esc_url',
        'type'               => 'option'

    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'galeria-image-two', array(
        'label'                => __('Imagen de slider', ''),
        'section'              => 'marketing_galeria',
        'settings'             => 'marketing[galeria-image-two]',
        'description'       => __('Sube una imagen para el slider de la página marequeting digital', '')
    )));

    // //////////////

    $wp_customize->add_setting('marketing[galeria-image-three]', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'esc_url',
        'type'               => 'option'

    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'galeria-image-three', array(
        'label'                => __('Imagen de slider', ''),
        'section'              => 'marketing_galeria',
        'settings'             => 'marketing[galeria-image-three]',
        'description'       => __('Sube una imagen para el slider de la página marequeting digital', '')
    )));

    // //////////////

    $wp_customize->add_setting('marketing[galeria-image-four]', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'esc_url',
        'type'               => 'option'

    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'galeria-image-four', array(
        'label'                => __('Imagen de slider', ''),
        'section'              => 'marketing_galeria',
        'settings'             => 'marketing[galeria-image-four]',
        'description'       => __('Sube una imagen para el slider de la página marequeting digital', '')
    )));

    // //////////////

    $wp_customize->add_setting('marketing[galeria-image-five]', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'esc_url',
        'type'               => 'option'

    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'galeria-image-five', array(
        'label'                => __('Imagen de slider', ''),
        'section'              => 'marketing_galeria',
        'settings'             => 'marketing[galeria-image-five]',
        'description'       => __('Sube una imagen para el slider de la página marequeting digital', '')
    )));

    // //////////////

    $wp_customize->add_setting('marketing[galeria-image-six]', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'esc_url',
        'type'               => 'option'

    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'galeria-image-six', array(
        'label'                => __('Imagen de slider', ''),
        'section'              => 'marketing_galeria',
        'settings'             => 'marketing[galeria-image-six]',
        'description'       => __('Sube una imagen para el slider de la página marequeting digital', '')
    )));

    // //////////////

    $wp_customize->add_setting('marketing[galeria-image-seven]', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'esc_url',
        'type'               => 'option'

    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'galeria-image-seven', array(
        'label'                => __('Imagen de slider', ''),
        'section'              => 'marketing_galeria',
        'settings'             => 'marketing[galeria-image-seven]',
        'description'       => __('Sube una imagen para el slider de la página marequeting digital', '')
    )));

    // //////////////

    $wp_customize->add_setting('marketing[galeria-image-eight]', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'esc_url',
        'type'               => 'option'

    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'galeria-image-eight', array(
        'label'                => __('Imagen de slider', ''),
        'section'              => 'marketing_galeria',
        'settings'             => 'marketing[galeria-image-eight]',
        'description'       => __('Sube una imagen para el slider de la página marequeting digital', '')
    )));

    // //////////////

    $wp_customize->add_setting('marketing[galeria-image-nine]', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'esc_url',
        'type'               => 'option'

    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'galeria-image-nine', array(
        'label'                => __('Imagen de slider', ''),
        'section'              => 'marketing_galeria',
        'settings'             => 'marketing[galeria-image-nine]',
        'description'       => __('Sube una imagen para el slider de la página marequeting digital', '')
    )));

    // //////////////

    $wp_customize->add_setting('marketing[galeria-image-then]', array(
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'esc_url',
        'type'               => 'option'

    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'galeria-image-then', array(
        'label'                => __('Imagen de slider', ''),
        'section'              => 'marketing_galeria',
        'settings'             => 'marketing[galeria-image-then]',
        'description'       => __('Sube una imagen para el slider de la página marequeting digital', '')
    )));
...
//    $wp_customize->add_setting('marketing_page[galleri-image-three]', array(
    ...
    // $wp_customize->add_setting('marketing_page[galleri-image-four]', array(
    //     'capability'        => 'edit_theme_options',
    //     'sanitize_callback' => 'esc_url',
    //     'type'               => 'option'
    ...
    //     'section'              => 'marketing_galeria',
    //     'settings'             => 'marketing_page[galleri-image-four]',
    //     'description'       => __('Sube una imagen para la geleria de la página de incio. Se recomienda una imagen de 2000px X 900px', '')
    // )));
