...
<div id="myModalRight" class="modal fade modal-right mt-5c" tabindex="-1" >
          ...
          <div class="d-flex w-100">
            ...
            <div class="col-lg-6">
              ...
              <form>
                ...
                id="exampleInputEmail1"
                aria-describedby="emailHelp"
                placeholder="Dejenos tu mensaje"
                >
                <button class="bg-white py-2 px-5 border-0 my-5" style="color: #ED1164; border-radius: 2.2rem;">Enviar mensaje</button>
            </form
            ...
            <div class="col-lg-6">
              <img  class="position-absolute" style="right: -1rem; height: 102%;" src="<?php echo get_template_directory_uri(); ?>/assets/images/bg-modal.svg">
