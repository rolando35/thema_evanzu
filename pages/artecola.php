	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 p-1 m-0 p-md-2">
				<img src="<?php echo $path_img?>Web-Artecola.jpg" class="w-100 h-100" />
			</div>
			<div class="col-md-6 p-0 m-0">
				<div class="d-flex flex-column h-100 w-100">
					...
					<div class="w-100 h-50 p-1 m-0 p-md-2">
						<img
							src="<?php echo $path_img?>Web-Artecola3.jpg"
							class="w-100 h-100"
						/>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-12 p-1 m-0 p-md-2">
				<img src="<?php echo $path_img?>01-triptico.jpg" class="w-100 h-100" />
			</div>
		</div>
		<!---------------images-------------->
		...
		<div class="row">
			<div class="col-md-6 p-1 m-0 p-md-2">
				<img
					src="<?php echo $path_img?>Fotografía-artecola.jpg"
					class="w-100 h-100"
				/>
			</div>
			<div class="col-md-6 p-1 m-0 p-md-2">
